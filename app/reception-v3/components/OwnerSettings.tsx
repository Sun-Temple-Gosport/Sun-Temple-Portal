...
export default function OwnerSettings({
  ...
  async function saveLocalPackage(id: number) {
    ...
    await onSave({
      ...pkg,
      minutes: pkg.is_unlimited ? 0 : pkg.minutes,
    });

    setSavingId(null);
  }

  function resetNewPackage() {
    setNewPackage({
      name: "",
      minutes: 0,
      price: 0,
          ...
          {mode === "products" && (
            <>
                ...
                <div className="rounded-2xl border border-slate-700 bg-slate-950 p-5">
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex min-h-[50px] items-center gap-3 rounded-xl border border-slate-700 bg-slate-900 px-4 py-3 font-bold text-white">
                        <input
                          type="checkbox"
                          checked={newPackage.is_unlimited}
                          onChange={(e) =>
                            setNewPackage({
                              ...newPackage,
                    ...
                    <label className="space-y-2">
                      ...
                      {newPackage.is_unlimited ? (
                        <div className="flex min-h-[50px] items-center rounded-xl border border-amber-400/40 bg-amber-400/10 px-4 py-3 font-black text-amber-400">
                          Unlimited
                        </div>
                      ) : (
                        <input
                  ...
                  <div className="mt-4 flex gap-2">
                    <button
                      ...
                      onClick={async () => {
                        await onCreate({
                          ...newPackage,
                          minutes: newPackage.is_unlimited
                            ? 0
                            : newPackage.minutes,
                        });
              ...
              {localPackages.map((pkg) => (
                ...
                >
                  <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-[1fr_120px_120px_120px_110px_100px] xl:items-end">
                    <div>
                    ...
                    <div>
                      ...
                      {pkg.is_unlimited ? (
                        <div className="mt-1 flex min-h-[50px] items-center rounded-xl border border-amber-400/40 bg-amber-400/10 px-3 py-3 font-black text-amber-400">
                          Unlimited
                        </div>
                      ) : (
                        <input
