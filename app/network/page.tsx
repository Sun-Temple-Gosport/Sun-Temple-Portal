            ...
            filteredSalons.map((salon) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    href={`/network/${salon.salon_id}`}
                    className="mt-5 flex w-full items-center justify-between rounded-2xl bg-amber-400 px-5 py-4 text-sm font-black text-slate-950 transition hover:bg-amber-300"
                  >
